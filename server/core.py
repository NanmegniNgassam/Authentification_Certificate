...
class Server:
    ...
    def __init__(self, config: Configuration, password: str, private_key_filename: str, csr_filename: str):
        self._config = config
        self._private_key = generate_private_key(private_key_filename,password) #complété
        self._csr = generate_csr(self._private_key,csr_filename ,self._config) #complété 
